...
import {
  ...
  ShortcutToActionMap, StateHolder, TextColor, TimerRegistry, useKeyboardCompatInkWithMapCached,
...
export const runHooks = (): HookOutput => {
  ...
  return {
    ...
    useKeyboard: useKeyboardCompatInkWithMapCached(createShortcuts),
    uid: `${count++}`
  }
}
