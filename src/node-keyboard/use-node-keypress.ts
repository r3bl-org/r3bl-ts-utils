 ...
 * keypress events, and the React function component that ends up using this hook to get async
 * events that are generated by an end user who's typing in a terminal. More information on this:
